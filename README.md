...
### 2025 SW중심대학 디지털 경진대회 : SW부문
  ...
  - 후원기업 딥노이드 상 수상
### 2025 K-ICT in Busan
  - Pilltip 출품 및 BEXCO 부산대학교 부스 전시
### SK AI SUMMIT 2025
  - 우수사례 선정 및 전시부스 운영
...
- **Backend**: Java 17, Spring Boot 3.4.5, mySQL, elasticsearch, redis, weaviate, NGiNX, Next.js
...
## 팀 Pilltip 💊
2025년 결성한 우리 필팁(Pilltip)은 모든 사람에게 편리한 개인맞춤 AI 복약관리 애플리케이션을 제공하는 것을 목표로 출발하였습니다.

네 명의 부산대학교 정보컴퓨터공학부|의류학과 20학번 학부생으로 구성된 우리 팀은

팀 단위 앱 개발을 통해 프로젝트의 성공적인 마무리 및 각 구성원의 실력 향상, 우애 도모를 목표로 합니다.
  ...
  <table>
    <tr>
     <td align="center" width="25%">
      ...
      <td align="center" width="25%">
        <img src="https://avatars.githubusercontent.com/u/162964181?v=4" width="100" height="100"><br>
        <a href="https://github.com/Mireutale">강태진</a><br>
        BE
      </td>
      <td align="center" width="25%">
        <img src="https://avatars.githubusercontent.com/u/96414625?v=4" width="100" height="100"><br>
